...
import { Anchor, Text, Button, Group, Paper, PasswordInput, Stack, TextInput, Container,  } from "@mantine/core";
...
const SignupStep1 = () => {
    return (
        ...
        <TextInput w={250} label="Email" placeholder="you@mantine.dev" required />
        <TextInput w={250}
            label="Password"
