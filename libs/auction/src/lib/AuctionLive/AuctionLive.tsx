...
import { lotMockData as lotsData } from '@auction-app/models';
import { BiddingTab } from './BiddingTab.tsx';
import { auctionLiveStyle } from '../theme/theme.ts';
import {
  IconCalendarEvent,
  IconClock,
  IconMoneybag,
...
const useStyles = createStyles(
  (theme): Record<string, CSSObject> => auctionLiveStyle(theme),
);
